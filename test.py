...
if __name__ == '__main__':
    ...
    # Directories
    parser.add_argument('--model_name', default='fftformer_GoPro', type=str)
    parser.add_argument('--data_dir', type=str, default='/home/test/Workspace/zc/dataset_IR/GoPro/test')
